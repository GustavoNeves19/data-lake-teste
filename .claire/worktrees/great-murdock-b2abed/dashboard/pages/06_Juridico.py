...
inject_css(); sidebar_brand()
page_header(title="⚖️ Jurídico e Homologações", subtitle="Contratos · Certidões · INMETRO · Compliance")
coming_soon("Setor em planejamento", "Fonte de dados a definir. Integração prevista para próxima sprint.")
st.markdown("""
**KPIs planejados:**
